  ...
  const features = [
    {
      ...
      icon: <Target className="text-drift-green" size={40} />,
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-12 lg:mb-24">
          <div className="relative">
            <div className="absolute -left-4 -top-4 w-24 h-24 border-l-4 border-t-4 border-drift-green"></div>
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-drift-green/20 blur-3xl rounded-full scale-75 group-hover:scale-90 transition-transform duration-700"></div>
            <ThreeDCard
