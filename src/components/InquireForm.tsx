    ...
    <section id="contact" className="py-32 relative overflow-hidden bg-black">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center text-center mb-16">
          <div className="inline-flex items-center gap-2 text-drift-green font-black tracking-[0.4em] text-xs mb-6 uppercase">
            <span className="w-12 h-[2px] bg-drift-green"></span> START YOUR ENGINE <span className="w-12 h-[2px] bg-drift-green"></span>
          </div>
          <h2 className="text-5xl md:text-8xl font-black font-racing italic mb-8 leading-none tracking-tighter">
            CONTACT THE <span className="text-drift-green text-glow">CIRCUIT</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          ...
          <a
            ...
            className="group relative p-8 bg-white/5 border border-white/10 rounded-3xl hover:bg-drift-orange/10 hover:border-drift-orange/50 transition-all overflow-hidden flex flex-col items-center text-center"
          >
            <div className="absolute top-0 right-0 w-24 h-24 bg-drift-orange/5 blur-2xl group-hover:bg-drift-orange/20 transition-all"></div>
            <div className="w-16 h-16 bg-drift-orange/20 rounded-2xl flex items-center justify-center text-drift-orange mb-6 group-hover:scale-110 transition-transform">
              <Mail size={32} />
            </div>
            <div className="text-[10px] font-black tracking-[0.3em] text-drift-orange mb-2 uppercase">Direct Mail</div>
            ...
            <ChevronRight className="mt-4 text-drift-orange opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
          </a>
        ...
        <div className="mt-20 flex flex-col items-center">
          <div className="px-8 py-4 bg-drift-orange/10 border border-drift-orange/20 rounded-full flex items-center gap-3">
            <Zap size={18} className="text-drift-orange" fill="currentColor" />
