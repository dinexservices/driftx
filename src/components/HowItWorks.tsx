...
const HowItWorks: React.FC = () => {
  ...
  const steps = [
    {
      ...
      icon: <Settings className="text-drift-green" size={40} />,
      stat: 'PHASE: GRID'
    },
    {
      id: '02',
      ...
      icon: <Ruler className="text-drift-green" size={40} />,
      stat: 'PHASE: DESIGN'
    },
    {
      id: '03',
      ...
      icon: <ShieldCheck className="text-drift-green" size={40} />,
      stat: 'PHASE: SCRUTINY'
    },
    {
      id: '04',
      ...
      icon: <Flag className="text-drift-green" size={40} />,
    ...
    },
    {
      ...
      icon: <Share2 className="text-drift-green" size={40} />,
      stat: 'PHASE: PODIUM'
    },
  ];
  ...
  return (
    <section
      id="process"
      ref={containerRef}
      className="relative bg-[#050505] overflow-visible z-[1]"
      style={{ height: `${steps.length * 100}vh` }}
    >
      {/* Sticky viewport content */}
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden relative z-[1]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            className="absolute top-[20%] left-[15%] w-[40rem] h-[40rem] opacity-20 blur-[150px] bg-drift-green/30 rounded-full"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="hidden lg:block lg:col-span-4 pl-12">
              <div className="flex items-center gap-6 mb-16 overflow-hidden">
                <div
                  className="w-16 h-[2px] bg-drift-green shadow-[0_0_15px_rgba(93,218,110,1)] transition-transform duration-500"
                ...
                <div className="font-racing italic font-black text-white tracking-widest text-2xl uppercase flex gap-2">
                  <span>PHASE</span>
                  <span className="text-drift-green">{steps[activeStep].id}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8">
                {steps.map((step, i) => (
                  ...
                  >
                    <div
                      className={`h-[3px] transition-all duration-700 rounded-full shadow-lg ${i === activeStep
                        ? 'w-16 bg-drift-green'
                        : i < activeStep
                          ? 'w-8 bg-drift-green/40'
                          : 'w-4 bg-white/10 group-hover:bg-white/30'
                        }`}
                    />
                    <span className={`text-xs font-black tracking-[0.3em] uppercase transition-all duration-300 ${i === activeStep
            ...
            <div className="lg:col-span-8 flex justify-center relative min-h-[500px]">
              {steps.map((step, idx) => {
                ...
                return (
                  <div
                    key={step.id}
                    className={`absolute inset-0 flex flex-col justify-center transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] transform ${isCurrent
                  ...
                  >
                    <div className="bg-gradient-to-br from-white/[0.08] to-white/[0.01] backdrop-blur-3xl border border-white/10 p-10 md:p-16 rounded-[3rem] relative overflow-hidden group shadow-[0_20px_100px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="absolute inset-0 bg-drift-green/0 group-hover:bg-drift-green/[0.02] transition-colors duration-500" />

                      <div className="inline-flex items-center gap-6 mb-10">
                        <div className="w-20 h-20 bg-drift-green/20 rounded-3xl flex items-center justify-center text-drift-green border border-drift-green/30 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(93,218,110,0.3)] transition-all duration-500">
                        ...
                        <div className="flex flex-col">
                          <span className="text-drift-green font-black tracking-widest text-xs mb-1">PROCESS_LOG</span>
                      ...
                      <div className="flex items-center gap-4">
                        <button className="bg-drift-green hover:bg-drift-green/90 text-black px-8 py-4 rounded-xl font-black font-racing italic text-sm tracking-widest transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(93,218,110,0.5)] active:scale-95 flex items-center gap-3">
                      ...
                      {/* Corner Accent */}
                      <div className="absolute bottom-0 right-0 w-32 h-32 bg-drift-green/10 rounded-tl-[100%] transition-all duration-700 group-hover:w-40 group-hover:h-40" />
                    </div>
                  </div>
                );
              })}
        ...
        <div className="absolute bottom-0 left-0 w-full h-1 bg-white/5 overflow-hidden">
          <div
            className="h-full bg-drift-green shadow-[0_0_20px_rgba(93,218,110,1)] transition-all duration-300 ease-out"
